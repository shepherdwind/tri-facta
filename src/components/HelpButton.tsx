...
export const HelpButton: React.FC<HelpButtonProps> = observer(({ gameStore }) => {
  ...
  return (
    <button
      className="px-4 py-2 text-sm font-medium text-white bg-gray-600 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-30 disabled:cursor-not-allowed disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:hover:bg-gray-400 dark:disabled:hover:bg-gray-600 disabled:border-2 disabled:border-dashed disabled:border-gray-500 disabled:text-gray-600 dark:disabled:text-gray-400"
      onClick={handleClick}
      disabled={isDisabled}
      title={t('game.help')}
    >
